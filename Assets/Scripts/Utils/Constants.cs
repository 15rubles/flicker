...
namespace Utils
{
    public static class Constants
    {
        ...
        public static readonly Color32 ExtraPowerColor = new Color32(110, 170, 99, 255);
        ...
        public const string MulliganCardHint = "Select one cart to mulligan";
        public const string PlayCardsHint = "Play as many cards as you want, you can rearange cards after play";
    }
}